...
/**
 * Les noms affichés sont normalement récupérés
 * directement depuis Supabase.
 *
 * Ce fallback permet simplement de garder une
 * interface correcte si une catégorie arrive sans nom.
 */
  ...
  return (
    <div className="space-y-8 p-4 lg:p-6">
      ...
      <section className="hero-gradient hero-depth relative overflow-hidden rounded-2xl border border-border">
        ...
        <div className="relative grid min-h-[280px] items-center gap-8 p-7 sm:p-10 lg:grid-cols-[1.25fr_.75fr] lg:p-12">
          ...
          <div className="hidden justify-end lg:flex">
            <div className="relative w-full max-w-sm">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-background/30 p-5 shadow-glow backdrop-blur-md">
                <div className="mb-5 flex items-center justify-between">
                  <span className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">
                    Smart Point
                  </span>

                  <span className="h-2.5 w-2.5 rounded-full bg-primary shadow-[0_0_15px_currentColor]" />
                </div>
